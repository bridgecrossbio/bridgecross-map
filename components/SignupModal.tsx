  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="p-8">
          {/* Badge */}
          <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full mb-5 text-xs font-bold text-white uppercase tracking-wide" style={{ backgroundColor: "#1C1C1C" }}>
            <span>⚡</span>
          ...
          <h2 className="text-2xl font-bold leading-snug mb-2" style={{ fontFamily: "Georgia, serif", color: "#1C1C1C" }}>
            Full access to the BridgeCross Map
          </h2>

          {/* Price */}
          <div className="flex items-baseline gap-2 mb-1">
            <span className="text-4xl font-bold" style={{ fontFamily: "Georgia, serif", color: "#1C1C1C" }}>£8</span>
            <span className="text-base font-medium" style={{ color: "#6B5E52" }}>/month</span>
          </div>
          <p className="mb-6" style={{ color: "#B83A2A", fontWeight: 700, fontSize: "15px" }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <button
              ...
              style={{
                ...
                boxShadow: "0 2px 12px rgba(184,58,42,0.35)",
              }}
            >
